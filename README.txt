...
1) The gear ratio in the program is computed based on the number of teeth on each gear. It is displayed as gearRatio:1 for ratios where the smaller gear is on the motor and as 1:gearRatio when the larger gear is on the motor, where gearRatio is the number of teeth in the larger gear divided by the number of teeth in the smaller gear.
